"""
Django settings for TranslateDjango project.
...
SECRET_KEY = '2h5xmjiizd!^@k9=_($8xs((&uy0p2pgw+x06_^wgup3_*ko2e'
...
ROOT_URLCONF = 'TranslateDjango.urls'
...
WSGI_APPLICATION = 'TranslateDjango.wsgi.application'
